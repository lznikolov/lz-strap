...
<div class="tableHome-bonusRows" id="<?= $t_name; ?>">
    <div class="container relativeContainer tableHome-sorting">
        <!--TABLE HEADER-->
        <div class="row">
            <div class="col-sm-2 tableHome-topLabel xs-hide text-center">
                <div class="vertical-align">Wettanbieter</div>
            </div>
            <div class="col-sm-1 tableHome-topLabel xs-hide text-center cursored tableHome-sorter"
            ...
            <div class="col-sm-2 tableHome-topLabel xs-hide text-center cursored tableHome-sorter"
            ...
            <div class="col-sm-3 tableHome-topLabel xs-hide text-center">
        ...
        <div class="row divBox <?= $hideTableElements ?>">
            ...
            <div class="row divBox exclusive <?= $hideTableElements ?>">
                <div class="container relativeContainer">
                    <div class="row exclusiveRow <?= $hideTableElements ?>">
                ...
                <div class="col-xs-12 col-sm-2 <?= $borderTopBigTable . ' ' . $borderTopBigTable2 ?>">
                    <div class="tableHome-bottomLabel xs-hide <?= $showLabelsBigTable ?>">
                    ...
                    <div class="tableHome-logo">
                        <a href="<?= getGoUrl($operator, 1) ?>" target="_blank" rel="nofollow">
                            <div class="tableHome-logoLink ">
                                <img
                                    src="/assets/images/logos_105x53/<?= strip4url($operator) ?>-105x53.png"
                ...
                <div class="col-xs-4 col-sm-1 <?= $borderTopBigTable ?>">
                    <div class="tableHome-bottomLabel <?= $showLabelsBigTable ?> tableHome-sorter"
                         data-checker="Sorter1">
                ...
                <!--UMSATZ-->
                <div class="col-xs-3 col-sm-2 xs-hide <?= $borderTopBigTable ?>">
                    <div class="tableHome-bottomLabel <?= $showLabelsBigTable ?> tableHome-sorter"
                         data-checker="Sorter5">
                ...
                <div class="col-xs-6 col-sm-3 <?= $borderTopBigTable ?>">
                    <div class="tableHome-bottomLabel <?= $showLabelsBigTable ?>">
                        <div class="vertical-align">Zum Anbieter</div>
                    </div>
