        ...
        <div class="modal-body" id="main-body">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <p>'.$_SERVER['HTTP_HOST'].' präsentiert in Kooperation mit interwetten diese exklusive Promotion für alle Neukunden von interwetten. Wir schenken ihnen 7 EUR Startguthaben ohne eine vorherige Einzahlung bei interwetten.</p>
                    <p>Registrieren Sie sich in 2 Minuten kostenlos bei interwetten. Sie erhalten den Gutschein ausschließlich wenn Sie sich über diesen Link registrieren</p>
                    <p> Tragen Sie nach der Registrierung hier die eMail-Adresse ein mit der Sie sich bei Interwetten angemeldet haben. Sie erhalten auf die gleiche eMail-Adresse Ihren 7 EUR Interwetten Wettgutschein.</p>
                </div>
...
';
    ?>
    <script type='text/javascript'> var operartor_voucher = 'interwetten';</script>
    <?php
}
else {
    function contact_form_mail($to, $subject, $message, $headers, $charset = 'utf-8', $from)
    {
        ...
        $mysubject = "interwetten voucher request from ".$_SERVER['HTTP_HOST']." client with IP: ".get_client_ip()."";
    ...
    //contact_form_mail("interwetten-gutschein@luckylabz.com", $_POST['email'], $message, '', 'utf-8', $_POST['email']);
}